...
hachidori: HAL_BOARD = HAL_BOARD_LINUX
hachidori: TOOLCHAIN = NATIVE
hachidori: all
...
FRAMES = heli
BOARDS = apm1 apm2 apm2beta apm1-1280 px4-v1 px4-v2 px4-v3 px4-v4 sitl flymaple linux erle pxf navio navio2 raspilot bbbmini minlure erlebrain2 bhat qflight pxfmini hachidori
BOARDS += vrbrain
